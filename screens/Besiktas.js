...
useEffect(() => {
const myDocc = doc(db,"bayi","BEŞİKTAŞ")
getDoc(myDocc)
  // Handling Promises
  .then((snapshot) => {
    // MARK: Success
...
// bayi tablosundan müşterileri çekme
 ...
 //-----------------------------------------------------------------
 let numList = [];
 for (let index = 0; index < user2.length-1;  index++) {
    numList.push(index);  
   } ;
     ...
     <ScrollView>
      <Image source={require('/Users/macbookair/uykusuzoto/u.png')} style={styles.image} />
        ...
        <View style={{ marginLeft:10 }}>
               ...
               <Text style=
                  {{margin: 10, alignItems: "center", textAlign: "center", fontSize: 26, backgroundColor: 'red',}}>
               Üye Listesi
               </Text> 
      ...
      { numList.map((num,index) =>(
              ...
              <View style={{width: 390,
                   ...
                   <Text  style={{ marginTop: 20,  textAlign: "center", fontSize: 26, backgroundColor: '#ffffff90' }}  >      
                    {num+1} . Üye     {user2[num+1]} {user3[num+1]}
                   </Text>
