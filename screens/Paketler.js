...
<Button title="Geri Dön" onPress={() => navigation.goBack()} />
        ...
        <View style={styles.kabin}>         
          <Text style={styles.title}>  PAKET 1 </Text>
                   <Text style={styles.paragraf}> 1 HAFTADA  1 KEZ YIKAMA
                         ...
                         <TouchableOpacity style={styles.button} onPress={() => { navigation.navigate('Paket1') }}>
        ...
        <View style={styles.kabin}>
          <Text style={styles.title}>  PAKET 2 </Text>
                   ...
                   <Text style={styles.paragraf}>                            + </Text>
                         ...
                         <TouchableOpacity style={styles.button} onPress={() => { navigation.navigate('Paket2') }}>
                             <Text style={styles.btext}>
                               SATIN AL
                             </Text>
                         </TouchableOpacity>
        ...
        <View style={styles.kabin}>
          <Text style={styles.title}>  PAKET 3</Text>
                   ...
                   <Text style={styles.paragraf}>                            + </Text>
                         ...
                         <TouchableOpacity style={styles.button} onPress={() => { navigation.navigate('Paket3') }}>
                             <Text style={styles.btext}>
                               SATIN AL
                             </Text>
                         </TouchableOpacity>
        ...
        <View style={styles.kabin}>
          <Text style={styles.title}> PAKET 4  </Text>
                   <Text style={styles.paragraf}>       1 HAFTADA HERGÜN                                      
                   </Text>
                   <Text style={styles.paragraf}>                      YIKAMA  
                                                        
                                                        </Text>
                   <Text style={styles.paragraf}>                             + </Text>
                         <Text style={styles.paragraf}>                     Cilalama </Text>
                         <Text style={styles.paragraf}>                      1299  TL</Text>
                         <TouchableOpacity style={styles.button} onPress={() => { navigation.navigate('Paket4') }}> 
                             <Text style={styles.btext}>
                               SATIN AL
                             </Text>
                         </TouchableOpacity>
