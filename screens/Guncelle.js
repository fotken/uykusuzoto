         ...
         <View style={styles.login}>
            ...
            />
              ...
              <View>
                ...
                <TextInput  value={arac} onChangeText={(text) => setArac(text)} style={styles.input} placeholder="Soyadınızı Giriniz" />
               
              </View>
              
              <View>
                <Text style={{fontSize: 17, fontWeight: '400', color: 'black' }}>Renk</Text>
                <TextInput  value={renk} onChangeText={(text) => setRenk(text)} style={styles.input} placeholder="Adres Giriniz" />
               
              </View>
              <View>
                <Text style={{fontSize: 17, fontWeight: '400', color: 'black' }}>Plaka</Text>
                <TextInput value={plaka} onChangeText={(text) => setPlaka(text)} style={styles.input} placeholder="Telefon Numarası Giriniz" />
              </View>
